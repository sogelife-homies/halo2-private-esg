...
// import "./SnarkedVault.sol";

// /**
//  * @title   SnarkedVault Factory
...
//      */
//     constructor(address _governance, uint24 _protocolFee) {
...
//         vault = new SnarkedVault();
//         vault.initialize(params, address(this));
